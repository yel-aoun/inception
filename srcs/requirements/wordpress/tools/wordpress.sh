...
wp core install --url=localhost/ --title=inception --admin_user=$DB_USER --admin_password=$DB_PASS --admin_email=$yel-aoun@gmail.com --allow-root
wp user create $WP_USR user42@gmail.com --role=author --user_pass=$WP_PWD --allow-root
